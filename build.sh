...
do
    ...
    $JAVA_HOME_1_5/bin/java -jar ./tool/yuicompressor.jar "${file}" --charset utf-8 -o "${file}.compress"
...
do
    ...
    mv "${file}" "./asset.bak/${file}"
    mv "${file}.merge" "${file}"
    $JAVA_HOME_1_5/bin/java -jar ./tool/yuicompressor.jar "${file}" --type css --charset utf-8 -o "${file}.compress"
    mv "${file}.compress" "${file}"
